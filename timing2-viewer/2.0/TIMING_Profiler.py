...
class TIMING_Profiler(QMainWindow): 
	...
	def get_table_data(self):
		self.Table_1E0T = []
		self.Header_1E0T = []
		filename = 'C:\\timing2-temp\\' + 'Table_1E0T.txt'
		f = open(filename,'r')
		...
		self.Table_0E1T = []
		self.Header_0E1T = []
		filename = 'C:\\timing2-temp\\' + 'Table_0E1T.txt'
		f = open(filename,'r')
		head_temp = f.readline()
		table_temp = f.readlines()
		f.close()
		...
		filename = 'C:\\timing2-temp\\' + 'Table_1E1T.txt'
		f = open(filename,'r')
		head_temp = f.readline()
		table_temp = f.readlines()
		f.close()
		...
		filename = 'C:\\timing2-temp\\' + 'Table_1E2T.txt'
		f = open(filename,'r')
		head_temp = f.readline()
		table_temp = f.readlines()
		f.close()
		...
		filename = 'C:\\timing2-temp\\' + 'Table_1E3T.txt'
		f = open(filename,'r')
		head_temp = f.readline()
		table_temp = f.readlines()
		f.close()
