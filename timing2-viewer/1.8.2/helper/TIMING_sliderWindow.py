...
class sliderWindow(QFrame):
	...
	def __init__(self, dataPath, BID, Row, Col, t_span, E, T, tag):
		...
		self.win1 = LabelImageQT1(dataPath, BID, Row, Col, self.E, self.T, self.t_prior, t_span, self.Tag)
		self.win2 = LabelImageQT1(dataPath, BID, Row, Col, self.E, self.T, self.t0, t_span, self.Tag)
		self.win3 = LabelImageQT1(dataPath, BID, Row, Col, self.E, self.T, self.t_post, t_span, self.Tag)
