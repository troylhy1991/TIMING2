...
class TPS(QMainWindow):
	def __init__(self):
		...
		self.move(300,150)
		self.resize(400,20)
		self.setWindowTitle('TIMING Protocol S/W 1.8')
		self.show()
	...
	def nanowell_click_slot(self,path,tag):
		...
		self.Nanowell = TIMING_Nanowell(path, BID, row, col, 1, self.dataset.snapshots, temp_tag)

		
		
		
	def about_func(self):
		QMessageBox.information(self,"About","Version: TPS 1.0 \n Author: Hengyang Lu \n Email: hlu9@uh.edu \n Copy Rights Reserved.")
