...
from track_worker2 import track_worker2

def TIMING_Tracker2(Data_DIR, Dataset_Name, Dataset_Output, Dataset_Blocks, Dataset_Frames, CORE_NUMBER):
    ...
    for parameter in parameters:
        p.apply_async(track_worker2, args=(parameter[0], parameter[1],parameter[2],parameter[3],parameter[4],parameter[5],))
    p.close()
    p.join()
